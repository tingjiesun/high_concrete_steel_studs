...
studMatName = 'ML15Al_Stud_D19'

steelSecName = 'Q690D_Steel_Section'
studSecName = 'ML15Al_Stud_D19_Section'
...
# ------------------------------------------------------------
# 6. ML15Al D19 stud material
# Keep the calibrated reference material law unchanged; only geometry changes.
