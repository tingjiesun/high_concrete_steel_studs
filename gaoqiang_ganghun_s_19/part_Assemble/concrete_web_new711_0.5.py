...
# Hole segments: each diameter is 0.5 mm larger than the matching stud.
hole_segments = (
    (26.5, 6.0),
    (19.5, 64.0),
    (32.5, 10.0),
...
# O-grid-like partition radii.  The first ring must remain outside the
# largest D32.5 hole (radius 16.25 mm), otherwise the circular partition
# intersects the void and the hole cells are no longer sweep-meshable.
O_GRID_R1 = 20.0
O_GRID_R2 = 30.0
O_GRID_R3 = 40.0
...
print('Hole segments: D26.5-L6, D19.5-L64, D32.5-L10')
